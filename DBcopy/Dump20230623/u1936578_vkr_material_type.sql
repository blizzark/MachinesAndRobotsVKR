...
CREATE TABLE `material_type` (
  `idmaterial_type` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `material_type` VALUES (1,'Видеоматериал'),(2,'3D модель'),(3,'Литература'),(4,'Изображение');
...
-- Dump completed on 2023-06-23 12:13:48
